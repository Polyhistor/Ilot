      ...
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl md:rounded-[2.5rem] p-5 md:p-10 shadow-sm border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            {/* Card 1 */}
            <div className="bg-[#F9F9F6] rounded-2xl md:rounded-3xl p-5 md:p-8 flex flex-col justify-between min-h-[180px] md:min-h-[320px]">
              <h3 className="text-base md:text-2xl font-bold text-[#0B0B1A]">Frictionless Access</h3>
              <p className="text-gray-600 text-xs md:text-base leading-relaxed mt-3 md:mt-8">
            ...
            {/* Card 2 */}
            <div className="bg-gray-50 rounded-2xl md:rounded-3xl p-5 md:p-8 flex flex-col justify-between min-h-[180px] md:min-h-[320px]">
              <h3 className="text-base md:text-2xl font-bold text-[#0B0B1A]">Regulatory Authority</h3>
              <p className="text-gray-600 text-xs md:text-base leading-relaxed mt-3 md:mt-8">
            ...
            <div className="md:col-span-2 rounded-2xl md:rounded-3xl p-5 md:p-8 flex flex-col justify-between min-h-[200px] md:min-h-[360px] relative overflow-hidden group">
              ...
              <h3 className="text-base md:text-2xl font-bold text-[#0B0B1A] relative z-10">Strategic Efficiency</h3>
              <p className="text-gray-800 font-medium text-xs md:text-base leading-relaxed relative z-10 max-w-md">
            ...
            <div className="rounded-2xl md:rounded-3xl p-5 md:p-8 flex flex-col justify-between min-h-[200px] md:min-h-[360px] relative overflow-hidden group">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-white/80 via-white/20 to-white/90" />
              <h3 className="text-base md:text-2xl font-bold text-[#0B0B1A] relative z-10">Absolute Transparency</h3>
              <p className="text-gray-800 font-medium text-xs md:text-base leading-relaxed relative z-10">
